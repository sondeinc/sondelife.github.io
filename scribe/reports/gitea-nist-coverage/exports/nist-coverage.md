...
28/103 controls present — Coverage 27.2%.
...
|---|---|---|---|
| `AC-3` | Satisfied | access-enforcement |  |
| `AC-3.7` | Satisfied | access-enforcement |  |
| `AC-3.8` | Satisfied | access-enforcement | Runtime revocation and route-level deny evidence require customer tenancy context. |
| `AC-3.13` | Satisfied | access-enforcement |  |
...
| `AC-7` | Satisfied | access-enforcement |  |
...
| `CM-6` | Satisfied | configuration-defaults-safety |  |
...
| Control | Status | Validation | Rationale |
|---|---|---|---|
| `IA-2` | Satisfied | auth-required |  |
| `IA-2.1` | Satisfied | mfa-required | Multifactor authentication for privileged accounts requires IdP configuration evidence. |
| `IA-2.2` | Satisfied | mfa-required | Multifactor authentication for non-privileged accounts requires IdP configuration evidence. |
| `IA-2.6` | Satisfied | auth-required | Network access to privileged accounts requires runtime access-policy evidence. |
| `IA-2.8` | Satisfied | auth-required | Replay-resistant authentication needs protocol and IdP configuration evidence. |
| `IA-5` | Satisfied | credential-storage-safety |  |
...
| `SC-5` | Satisfied | — | Denial-of-service protection requires perimeter and capacity evidence. |
