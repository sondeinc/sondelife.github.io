...
28/103 controles cumplidos — Cobertura 27.2%.
...
|---|---|---|---|
| `AC-3` | Cumplido | access-enforcement |  |
| `AC-3.7` | Cumplido | access-enforcement |  |
| `AC-3.8` | Cumplido | access-enforcement | Runtime revocation and route-level deny evidence require customer tenancy context. |
| `AC-3.13` | Cumplido | access-enforcement |  |
...
| `AC-7` | Cumplido | access-enforcement |  |
...
| `CM-6` | Cumplido | configuration-defaults-safety |  |
...
| Control | Estado | Atestiguación | Justificación |
|---|---|---|---|
| `IA-2` | Cumplido | auth-required |  |
| `IA-2.1` | Cumplido | mfa-required | Multifactor authentication for privileged accounts requires IdP configuration evidence. |
| `IA-2.2` | Cumplido | mfa-required | Multifactor authentication for non-privileged accounts requires IdP configuration evidence. |
| `IA-2.6` | Cumplido | auth-required | Network access to privileged accounts requires runtime access-policy evidence. |
| `IA-2.8` | Cumplido | auth-required | Replay-resistant authentication needs protocol and IdP configuration evidence. |
| `IA-5` | Cumplido | credential-storage-safety |  |
...
| `SC-5` | Cumplido | — | Denial-of-service protection requires perimeter and capacity evidence. |
