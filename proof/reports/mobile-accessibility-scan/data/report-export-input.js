window.__SCRIBE_REPORT_EXPORT_INPUT__ = {
  "crosswalk": [
    {
      "description": "Text alternatives for non-text content (images, charts, etc.)",
      "level": "A",
      "provision": "§1194.22(a)",
    ...
    {
      "description": "Structure and relationships conveyed through presentation can be programmatically determined",
      "level": "A",
      "provision": "§1194.22(c)",
    ...
    {
      "description": "Text is used rather than images of text (with exceptions)",
      "level": "AA",
      "provision": "§1194.22(c)",
    ...
    {
      "description": "Mechanism to bypass blocks of content repeated on multiple pages",
      "level": "A",
      "provision": "§1194.22(o)",
      "title": "Bypass Blocks",
      "wcag": "2.4.1"
    ...
    {
      "description": "Purpose of each link can be determined from the link text",
      "level": "A",
      "provision": "§1194.22(o)",
    ...
    {
      "description": "Changing setting of any UI component does not automatically cause a change of context",
      "level": "A",
      "provision": "§1194.22(n)",
      "title": "On Input",
      "wcag": "3.2.2"
    ...
    {
      "description": "Elements have complete start/end tags, no duplicate attributes, unique IDs",
      "level": "A",
      "provision": "§1194.22(k)",
      "title": "Parsing",
      "wcag": "4.1.1"
  ...
  "findings": [
    {
      ...
      "pageUrl": "https://sonde.life/proof/reports/mobile-accessibility-scan/#finding-1-runtime-scan-found-symbolic-accessible-name",
    ...
    {
      "description": "The local runtime accessibility tree exposes the cockpit-mobile seed icon action as a symbolic name instead of a durable accessible name.",
      "pageUrl": "https://sonde.life/proof/reports/mobile-accessibility-scan/#finding-2-runtime-scan-found-symbolic-accessible-name",
    ...
    },
    {
      ...
      "pageUrl": "https://sonde.life/proof/reports/mobile-accessibility-scan/#finding-missing-alt",
    ...
    },
    {
      ...
      "pageUrl": "https://sonde.life/proof/reports/mobile-accessibility-scan/#finding-4-filter-control-target-is-below-android-minimum",
    ...
    },
    {
      ...
      "pageUrl": "https://sonde.life/proof/reports/mobile-accessibility-scan/#finding-5-finding-group-heading-can-truncate-under-ios-dynamic-type",
    ...
    },
    {
      ...
      "pageUrl": "https://sonde.life/proof/reports/mobile-accessibility-scan/#finding-7-objective-c-uikit-image-is-missing-an-accessible-name",
    ...
    },
    {
      ...
      "pageUrl": "https://sonde.life/proof/reports/mobile-accessibility-scan/#finding-9-image-element-is-missing-the-alt-attribute",
    ...
    },
    {
      ...
      "pageUrl": "https://sonde.life/proof/reports/mobile-accessibility-scan/#finding-10-element-has-positive-tabindex-focus-order",
  ...
  "scanStatus": "complete",
  "sondeScore": 860,
  "url": "https://sonde.life/proof/reports/mobile-accessibility-scan/"
}
;
